          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                ...
                className="bg-blue-600 text-white px-8 py-3 rounded-lg font-bold shadow-lg hover:bg-blue-700 transition-all"
              >
                Join WORSO
              </button>
              <button 
              onClick={() => navigate('/associates/list')}
              className="bg-white border border-slate-200 text-slate-700 px-8 py-3 rounded-lg font-bold hover:bg-slate-100 transition-all flex items-center gap-2">
