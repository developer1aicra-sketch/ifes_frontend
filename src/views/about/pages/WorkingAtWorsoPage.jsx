  ...
  <div className="space-y-8">
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-3xl font-bold text-slate-900">Working at IFSE</h2>
      </div>
      <p className="text-lg text-slate-600 leading-relaxed">
        Do you dream of shaping the future of competitive gaming? Do you crave a career that combines passion, purpose, and cutting-edge technology? Look no further than the World Robotics Sports Organization (IFSE), the leading force driving the global growth and recognition of eSports.
      </p>
    </div>

    <div className="space-y-4 pt-6 border-t border-slate-100">
      <h3 className="text-2xl font-bold text-slate-900">Here&apos;s why working for IFSE is more than just a job:</h3>
      <ul className="space-y-6">
        {[
          ...
          { title: 'Diverse Opportunities', desc: 'From event management and athlete relations to anti-doping and game development initiatives, IFSE offers a diverse range of career paths to suit your skills and passion.', icon: Layers },
    ...
    <div className="space-y-4 pt-6 border-t border-slate-100 bg-gradient-to-r from-blue-50 to-slate-50 rounded-2xl p-8 border border-blue-100">
      <p className="text-lg text-slate-600 leading-relaxed">
        IFSE is more than just an organization; it&apos;s a movement. A movement that celebrates the power of gaming, champions fair play, and empowers the next generation of athletes and leaders. By joining IFSE, you become an integral part of this movement, shaping the future of eSports and contributing to a more inclusive and impactful world.
      </p>
    </div>
  </div>
);
