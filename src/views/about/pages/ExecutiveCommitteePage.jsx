  ...
  <div className="space-y-8">
    <div className="space-y-4">
      ...
      <p className="text-lg text-slate-600 leading-relaxed">
        The Executive Committee of the World Robotics Sports Organization (IFeS) is composed of esteemed leaders in the esports industry, tasked with guiding the federation&apos;s strategic vision and policies. They oversee global initiatives, drive the growth of competitive gaming, and ensure fair, inclusive practices. By fostering collaboration with national organizations, governments, and stakeholders, the committee plays a pivotal role in shaping the future of esports worldwide and ensuring its sustainable development.
      </p>
    </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-2xl p-8 border border-blue-100">
          ...
          <p className="text-slate-600 mb-4">
            The Executive Committee convenes quarterly to review progress, set strategic direction, and make key decisions for IFeS&apos;s global operations.
          </p>
