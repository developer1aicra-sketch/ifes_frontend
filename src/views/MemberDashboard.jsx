...
const MemberDashboard = ({ user, currentSite, setView, setUser }) => {
  ...
  return (
    <div className="animate-fadeIn bg-slate-50 min-h-screen flex flex-col h-ful">
      <div className=" mx-auto  flex-1 w-full h-full ">
        <div className="bg-white  shadow-lg border border-slate-200 overflow-hidden flex flex-col lg:flex-row h-full min-h-[100vh] sm:min-h-[100vh] lg:min-h-[100vh] max-h-[calc(100vh-5rem)] sm:max-h-[calc(100vh-8rem)] h-screen">
          ...
          >
            ...
            <div className="relative flex-shrink-0 p-4 sm:p-6 pb-2 flex items-start justify-between gap-2">
              <NavLink className="flex items-center gap-3 min-w-0" to='/' >
          ...
          <main className="flex-1 min-h-0 bg-white flex flex-col min-w-0">
            ...
            >
              ...
              {activeTab === 'class-schedule' && (
                <MakeYourBotSchedule surfaceClassName={cardBg} />
              )}
