    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-slate-800 mb-3">Terms of Use</h1>
          <div className="h-1 w-20 bg-blue-600 mx-auto mb-4"></div>
          <p className="text-slate-600 text-sm">Version 1.0 | Effective Date: December 1, 2023</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sm:p-8">
          ...
          <section className="mb-10">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-800">Eligibility and Membership</h2>
            </div>
            
            <div className="pl-11">
              <div className="mb-4">
                <h3 className="font-semibold text-slate-800 mb-2">1.1 Eligibility</h3>
              ...
              <div className="mb-4">
                <h3 className="font-semibold text-slate-800 mb-2">1.2 Membership</h3>
              ...
              <div className="mb-4">
                <h3 className="font-semibold text-slate-800 mb-2">1.3 Anti-Doping Policy</h3>
                <p className="text-slate-700">
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2">1.4 Compliance</h3>
                <p className="text-slate-700">
          ...
          <section className="mb-10">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-800">User Accounts and Content</h2>
            </div>
            
            <div className="pl-11">
              <div className="mb-6">
                <h3 className="font-semibold text-slate-800 mb-2">2.1 Account Creation</h3>
                <p className="text-slate-700">
              ...
              <div className="mb-6">
                <h3 className="font-semibold text-slate-800 mb-2">2.2 User Content</h3>
                <p className="text-slate-700 mb-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-3">2.3 Prohibited Content</h3>
          ...
          <section className="mb-10">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-800">Use of WORSO Services</h2>
            </div>
            
            <div className="pl-11">
              <div className="mb-6">
                <h3 className="font-semibold text-slate-800 mb-2">3.1 Permitted Use</h3>
                <p className="text-slate-700">
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-3">3.2 Restrictions</h3>
                <p className="text-slate-700 mb-4">
                  You may not:
                </p>
                <ul className="space-y-2 pl-4">
          ...
          <section className="mb-10">
            <div className="flex items-center mb-4">
              <div className="bg-blue-100 text-blue-800 font-bold rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">4</div>
              <h2 className="text-xl font-bold text-slate-800">Third-Party Content and Links</h2>
            </div>
            
            <div className="pl-11">
              <div className="mb-6">
                <h3 className="font-semibold text-slate-800 mb-2">4.1 Third-Party Content</h3>
                <p className="text-slate-700">
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2">4.2 Third-Party Advertising</h3>
                <p className="text-slate-700">
          ...
          <section className="mb-10">
            ...
            <div className="pl-11">
              <div className="mb-6">
                <h3 className="font-semibold text-slate-800 mb-2">5.1 WORSO Content</h3>
                <p className="text-slate-700">
              ...
              <div>
                <h3 className="font-semibold text-slate-800 mb-2">5.2 User Content</h3>
                <p className="text-slate-700">
          ...
          <section className="bg-amber-50 p-6 rounded-lg border border-amber-100">
            <div className="flex items-center mb-3">
              ...
              <h2 className="text-xl font-bold text-slate-800">Disclaimer of Warranties</h2>
            </div>
            ...
            <p className="text-slate-700 mt-3 pl-11">
