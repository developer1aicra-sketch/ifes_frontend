...
gains: [
  {
    ...
    blurb:
      'Be part of the International Federation of Esports network and gain international visibility for your club and players.',
    icon: 'trophy',
  },
  {
    id: 'competition',
    title: '🎮 Access to Competitions',
    blurb: [
      'IFES-sanctioned tournaments',
      'Regional championships',
      'Global platforms like the IFES Esports World Cup',
    ],
    icon: 'users',
  },
  {
    ...
    blurb: [
      ...
      'Players, teams, and industry experts',
      'Esports federations and partners',
    ],
    icon: 'users',
  },
  {
  ...
  },
  {
    ...
    blurb: [
      'Club recognition on IFES platforms',
