...
//           {/* Carousel Stage */}
//           <div className="flex items-center bg-red-500 justify-center gap-6 transition-all duration-500">
//             <ChampionCard
...
// UPDATED DATA - New winners ranking with correct information
const HALL_OF_FAME_WINNERS = [
  {
    id: 1,
    name: "Robotics and Aviation",
    country: "India",
    countryCode: "in",
    rank: "#4",
    medal: "Excellence in Innovation",
    image: "https://placehold.co/400x400/1a2a3a/ffd966?text=RA",
    bio: "Pioneering robotics education and competitive excellence across India.",
    achievements: "National Champion 2024, Best Engineering Design",
    isWinner: false,
  },
  {
    id: 2,
    ...
    countryCode: "az",
    rank: "#5",
    medal: "Strategic Excellence",
    image: "https://placehold.co/400x400/1a2a3a/ffd966?text=WRC",
    bio: "Dominant force from Caucasus, known for tactical precision.",
    achievements: "Regional Champion, Best Strategy Award",
    isWinner: false,
  },
  {
    id: 3,
    name: "KARMA YODHA BOTS",
    country: "India",
    countryCode: "in",
    rank: "#6 · ELITE",
    medal: "Grand Champion · Golden Trophy",
    image: "https://placehold.co/400x400/1a2a3a/ffd966?text=KYB",
    bio: "Undisputed champions with revolutionary combat robotics.",
    achievements: "World Championship Title, 3x National Winner",
    isWinner: true,
  },
  {
    id: 4,
    ...
    rank: "#7",
    medal: "Silver Excellence · Precision Award",
    image: "https://placehold.co/400x400/1a2a3a/ffd966?text=ATOM",
    bio: "Master of robotics algorithms, 3x national champion.",
    achievements: "World Finals Top 8, Most Innovative Design",
    isWinner: false,
  },
  {
    ...
    rank: "#8",
    medal: "Rising Star · Best Newcomer",
    image: "https://placehold.co/400x400/1a2a3a/ffd966?text=TX",
    bio: "Youngest team to reach semifinals, known for aggressive tactics.",
    achievements: "Golden Bot Award 2025",
    isWinner: false,
  },
  ...
  return (
    <section className="relative py-20 px-4 md:py-28 overflow-hidden bg-[#01070c]">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex justify-center gap-5 mt-4">
          <span className="text-[#aac8ff] text-sm">
            <i className="fas fa-hand-pointer"></i> Tap card to view full profile
          </span>
        </div>
