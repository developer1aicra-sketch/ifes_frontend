  ...
  <section id="about-robo" className="relative py-24 bg-[#020b10] border-t border-cyan-500/10 overflow-hidden font-sans">
    ...
    <div className="relative z-10 max-w-6xl mx-auto px-6">
      ...
      >
        ...
        <h2 className="text-4xl md:text-6xl font-black text-white mt-4 leading-tight tracking-tighter">
          Build, lead, and represent
          <br />
          <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
            your esports club on the world stage
          </span>
        </h2>
        <div className="mt-6 space-y-3">
          <p className="text-slate-400 text-lg leading-relaxed">
            "The EX Club Program by International Federation of Esports is designed to empower institutions, colleges, universities, gaming communities, and independent groups to become part of a global esports ecosystem."
          </p>
          <p className="text-slate-400 text-lg leading-relaxed">
            "Whether you are a campus club, gaming community, or a group of passionate players—EX Clubs provide you with the platform to organize, compete, and grow within an internationally connected network."
          </p>
        </div>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-24">
        {[
          {
            title: 'Mission',
            body: 'To provide practical learning, competitive exposure, and industry connect through robotics programs, events, and real-world challenges.',
            Icon: Target,
            borderColor: 'group-hover:border-cyan-500/50',
            glow: 'bg-cyan-500/10',
          },
